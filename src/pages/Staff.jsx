...
export default function Staff() {
  ...
  // Starter plan gets fully locked out of staff management — but only once
  // at least one staff member exists. Locking it before that would leave a
  // brand-new Starter business with no way to ever add their first login,
  // since /staff is how the owner creates themselves as a staff user.
  if (staffList.length === 0) return staffContent

  return <ProLock feature="Staff management">{staffContent}</ProLock>
}